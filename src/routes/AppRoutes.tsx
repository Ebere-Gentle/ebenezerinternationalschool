...
const AppRoutes: React.FC = () => (
  <Routes>
    ...
    <Route path="/admin" element={<ProtectedRoute><MainLayout /></ProtectedRoute>}>
      ...
      <Route path="results/enter-ca" element={<AdminEnterCA />} />
