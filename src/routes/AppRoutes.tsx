...
import TeacherEnterCA from '../pages/teacher/results/TeacherEnterCA';
...
import AssessmentSettingsAdmin from '../pages/settings/AssessmentSettingsAdmin';
import { useResultsSidebarFix } from '../utils/resultsSidebarFix';

const AppRoutes: React.FC = () => {
  useResultsSidebarFix();
  ...
  return (
    <Routes>
      ...
      <Route path="/parent" element={<ProtectedRoute allowedRoles={['parent']}><MainLayout /></ProtectedRoute>}>
        <Route path="dashboard" element={<ParentDashboard />} /><Route path="pay-bill/:studentId" element={<ParentPayBill />} /><Route path="pay-bill" element={<ParentPayBill />} /><Route path="children" element={<MyChildren />} /><Route path="profile" element={<ParentProfile />} /><Route path="payment/:studentId" element={<ParentPaymentHistory />} /><Route path="payment" element={<ParentPaymentHistory />} /><Route path="jamb-cbt" element={<JambCbtProgress />} /><Route path="results/test" element={<ParentViewTest />} /><Route path="results/exam" element={<ParentViewExam />} /><Route path="results/cbt" element={<ParentViewCBT />} /><Route path="results/summary" element={<ParentResultSummary />} /><Route index element={<Navigate to="/parent/dashboard" replace />} /><Route path="*" element={<Navigate to="/parent/dashboard" replace />} />
      </Route>
      <Route path="/admin-asst" element={<ProtectedRoute allowedRoles={['admin','director','admin_asst','record_keeper']}><MainLayout /></ProtectedRoute>}><Route path="dashboard" element={<AdminAsst />} /><Route path="students" element={<AdminAsst />} /><Route path="classes" element={<AdminAsst />} /><Route path="sessions" element={<AdminAsst />} /><Route path="collections" element={<AdminAsst />} /><Route path="inventory" element={<AdminAsst />} /><Route path="reports" element={<AdminAsst />} /><Route path="activity" element={<AdminAsst />} /><Route path="payment" element={<AdminAsstPayment />} /><Route path="settings" element={<AdminAsst />} /><Route path="profile" element={<AdminAsstProfile />} /><Route index element={<Navigate to="/admin-asst/dashboard" replace />} /><Route path="*" element={<Navigate to="/admin-asst/dashboard" replace />} /></Route>
      <Route path="/school-backup" element={<ProtectedRoute><MainLayout /></ProtectedRoute>}><Route index element={<SchoolBackup />} /></Route><Route path="/promotion" element={<ProtectedRoute><MainLayout /></ProtectedRoute>}><Route index element={<StudentPromotion />} /><Route path="*" element={<Navigate to="/promotion" replace />} /></Route>
      <Route path="/" element={<ProtectedRoute><MainLayout /></ProtectedRoute>}>
        <Route path="students" element={<StudentsList />} /><Route path="students/:id" element={<StudentDetails />} /><Route path="students/edit/:id" element={<EditStudent />} /><Route path="students/register" element={<RegisterStudent />} /><Route path="teachers" element={<TeachersList />} /><Route path="teachers/add" element={<AddTeacher />} /><Route path="teachers/:id" element={<ViewTeacher />} /><Route path="teachers/edit/:id" element={<AddTeacher />} /><Route path="subjects" element={<SubjectsManagement />} /><Route path="timetable" element={<TimetablePage />} /><Route path="payments" element={<PaymentsList />} /><Route path="payments/record" element={<RecordPayment />} /><Route path="receipt-verification" element={<ReceiptVerification />} /><Route path="verify-receipt" element={<ReceiptVerification />} /><Route path="payments/verify" element={<ReceiptVerification />} /><Route path="fees" element={<FeesList />} /><Route path="fees/:id" element={<FeeDetail />} /><Route path="fees/edit/:id" element={<FeeEdit />} /><Route path="fees/create" element={<CreateFee />} /><Route path="classes" element={<ClassesList />} /><Route path="parents/create" element={<ParentManagement />} /><Route path="branches" element={<BranchesList />} /><Route path="staff" element={<StaffManagement />} /><Route path="attendance" element={<AttendanceManagement />} /><Route path="leave-requests" element={<LeaveRequests />} /><Route path="houses" element={<HousesPage />} /><Route path="transport" element={<TransportPage />} /><Route path="library" element={<LibraryPage />} /><Route path="announcements" element={<AnnouncementsPage />} /><Route path="messages" element={<MessagesPage />} /><Route path="communications" element={<MessagesPage />} /><Route path="notices" element={<NoticesPage />} /><Route path="notifications" element={<NotificationsCenter />} /><Route path="reports" element={<ReportsDashboard />} /><Route path="settings" element={<SettingsHub />} /><Route path="settings/assessment" element={<AssessmentSettingsAdmin />} /><Route path="profile" element={<Profile />} /><Route index element={<DashboardRouter />} /><Route path="*" element={<DashboardRouter />} />
      </Route>
