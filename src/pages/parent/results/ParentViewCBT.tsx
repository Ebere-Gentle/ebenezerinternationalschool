  ...
  return (
    <div className="container mx-auto p-4">
      <motion.div
        ...
        className="space-y-6"
      >
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">View CBT Results</h1>
          ...
          <>
            ...
            {loading ? (
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 text-center">
                <p className="text-gray-500 dark:text-gray-400">No CBT results available for this child.</p>
              </div>
            )}
          </>
        ) : (
