      ...
      >
        ...
        {!loading && results.length > 0 && (
          <ResultTable
            ...
            subject={subjects.find(s => s.id === filters.subjectId)?.name}
            term={filters.term}
        ...
        {!loading && results.length === 0 && filters.classId && (
          <div className="text-center py-12 bg-white dark:bg-gray-800 rounded-2xl shadow-xl">
            <p className="text-gray-500 dark:text-gray-400">No results found. Please adjust your filters.</p>
          </div>
        )}
      </motion.div>
    </div>
